...
const weirdLoadingPhrases = [ 
    ...
    "Compelling you with the power of Christ",
    ...
    "Loading feigned interest in your musical aspirations...",
    "Recording this for quality assurance purposes or whatever...",
    "Assuming the worst and still getting surprised...",
    "Reallocating RAM to post cat pictures on your socials...",
    "Baking sequences into your toaster...",
    "Ripping a hole in the space-time continuum...",
    "Assessing how to make the situation even worse...",
    "Laughing at your jokes to keep the peace...",
    "Respecting women...",
    "Virtue signaling virtue signalers...",
    "Deploying digital gremlins to eat your cookies...",
    "Decompressing after a long day of compressing...",
    "Separating fact from fiction...",
    "Validating your feelings...",
    "Giving hipsters hope...",
    "Contemplating the nature of existence and sobbing...",
    "Searching for meaning in 4 letter meme acronyms...",
    "Hoping for a better future that involves a jacuzzi...",
    "Praising the sun...",
    "Traveling back in time to invest in Bitcoin...",
    "Prank calling with the work phone...",
    "Obsessing over the global wealth distribution...",
    "Negotiating with the intrusive thoughts...",
    "Faking it until the authorities intervene...",
    "Deferring my credit card debt to a higher power...",
    "Praying that it was just a fart...",
    "Rebranding the bug into a feature...",
    "Breaking the foundations of the world...",
    "Rising to the occasion with a Commodore 64...",
    "Misrepresenting the evidence...",
    "Looking back in anger...",
    "Resurrecting arguments from the shadow realm...",
    "Localizing data metrics to catch them slipping...",
    "Sending a long-winded voicemail to my representative...",
    "Maximizing effort for marginal gains...",
    "Remixing a voicemail from management with a talk box filter...",
    "Recycling old jokes hoping you don’t notice...",
    "Recovering patient who escaped containment...",
    "Isolating the exact words she said before she left...",
    "Dismantling oppressive structures with catchy slogans...",
    "Converting your angst into silly shapes...",
    "Composing poetry to recite in the disabled stall...",
    "Annotating ancient manuscripts with permanent markers...",
    "Rewriting history from the perspective of a fire hydrant...",
    "Calibrating celebrities’ canthal tilts...",
    "Reducing lung inflammation with a trunk of incense...",
    "Reallocating funds into the depths of virtual speculation...",
    "Encouraging your worst habits...",
    "Summoning spirits for their compression value...",
    "Compressing the 3d model into a blob...",
    "Considering the pros and cons of clown college...",
    "Installing & forgetting until the hard drive cries for mercy...",
    "Harvesting your despair and torment for v-bucks...",
    "Jiggling when it should be wiggling...",
    "Compiling the error of your ways...",
    "Confirming your confirmations...",
    "Loading unnamed horrors...",
    "Declassifying sensitive documents to my cat...",
    "Deploying data gremlins to post pictures of your ex on IG...",
    "Releasing the thunder...",
    "Staring into your soul and finding only pain...",
    "Demonstrating performative male protocol...",
    "Recording your soul's contents for tax purposes...",
    "Silently judging your search history...",
    "Refreshing the website for the thousandth time",
    "Processing written requests with a paper shredder...",
    "Calculating your escape from Samsara based on your karmic history...",
    "Improvising digital infrastructure with a fly's neural circuitry...",
    "Approximating infinity with a Dollar General kaleidoscope...",
    "Spicing up your airways...",
    "Assessing your employment history to determine respect coefficient...",
    "Letting the interns handle this one...",
    "Acquiring a taste for freeform jazz...",
    "Informing loved ones of your downfall...",
    "Using the royal we to disperse accountability...",
    "Enjoying new Tame Impala reluctantly...",
    "Improvising cold calls to special interest groups with the grace of a worm...",
    "Entering animal sensitivity training due to remarks about worms...",
    "Imagining the target audience wearing silly hats...",
    "Promoting questionable supplements to redpilled sigmas...",
    "Seeking patterns in the Sunday newspaper...",
    "Configuring dopamine receptors behind a pay wall...",
    "Manipulating data retention to match the profile of a potato...",
    "Defecting to the dark side because they had cookies...",
    "Comparing data points against internal matrices...",
    "Visualizing the narrative with more googly eyes...",
    "Assigning philosophy majors to the padded room for silly people...",
    "Sugarcoating harsh truths in real time...",
    "Trying to act normal in front of my therapist to avoid the grippy socks...",
    "Demystifying the absurd with nuance and a plunger...",
